...
| **P09 · Entiende los bloqueos** | Se conservan principio, bloque técnico común sobre uso del bloqueo y cierre | NO | **PERMITIDO** | **PERMITIDO** | El bloque Core «PASA CERCA DEL BLOQUEO», incluido el principio «hombro con hombro» y la responsabilidad de quien utiliza el bloqueo, es invariable. Solo puede sustituirse el párrafo de responsabilidades posicionales. |
...
| **P09** | Override | Sustituye únicamente el párrafo que comienza «Según tu función tendrás que aprender...». Se conservan la introducción, la lista de principios, el bloque Core «PASA CERCA DEL BLOQUEO» completo y el cierre sobre seguir jugando. Ningún role pack ni hybrid bridge puede sustituir, recortar o contradecir el principio «hombro con hombro». |
...
# 17. PRINCIPIO TÉCNICO INVARIABLE EN BLOQUEOS

El contenido Core de P09 sobre el uso cerrado del bloqueo es común a todas las posiciones y combinaciones.

Debe conservarse íntegro:

- quien utiliza el bloqueo debe pasar suficientemente cerca de quien bloquea;
- el criterio operativo es **hombro con hombro**;
- dejar espacio facilita que el defensor atraviese el bloqueo;
- cerrar ese espacio es responsabilidad de quien utiliza el bloqueo;
- quien bloquea debe mantener una posición legal y no desplazarse para corregir la trayectoria del beneficiado;
- el principio se aplica tanto a bloqueos directos como indirectos.

Ningún role pack ni hybrid bridge puede sustituir, recortar, contradecir o reasignar esta responsabilidad.

---

# 18. LÍMITE MÉDICO Y DE SALUD
...
# 23. PRINCIPIO FINAL DE COMPOSICIÓN
